...
def main():
    parser = argparse.ArgumentParser(description='Convert Blender camera poses to Replica format')
    parser.add_argument('base_dir', help='Base directory path containing camera_transforms.txt')
